...
function getURLReplacement({
  ...
  if (relative) {
    let parsed = _url().default.parse((0, _.relativeBundlePath)(fromBundle, toBundle, {
      leadingDotSlash: false
    }));

    parsed.hash = orig.hash;
    to = _url().default.format(parsed);
  } else {
    let parsed = _url().default.parse((0, _nullthrows().default)(toBundle.name));

    parsed.hash = orig.hash;
    to = (0, _.urlJoin)(toBundle.target.publicUrl, _url().default.format(parsed));
  }
