...
class FSHost {
  ...
  readDirectory(root, extensions, excludes, includes, depth) {
    ...
    return this.ts.matchFiles(root, extensions, excludes, includes, this.ts.sys.useCaseSensitiveFileNames, this.getCurrentDirectory(), depth, // $FlowFixMe[method-unbinding]
    this.getAccessibleFileSystemEntries.bind(this), // $FlowFixMe[method-unbinding]
